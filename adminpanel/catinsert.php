...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Category Management
        <small>Manage Category Details</small>
      </h1>
      <!-- <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form name="frmEdit" action="catadd.php" method="post">
              <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Cat Id"  name="id">
        
        
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Cat Name" name="name">
